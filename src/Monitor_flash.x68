...
* Modified by : Kazuhiro Ouchi (@kanpapa)  May 9 2021
...
************************************************
REGSBASE    equ $FFFFF000     * internal registers base address
BASEA       equ REGSBASE+$100 * group A base register
BASEB       equ REGSBASE+$102 * group B base register
BASEC       equ REGSBASE+$104 * group C base register
BASED       equ REGSBASE+$106 * group D base register
CSA         equ REGSBASE+$110 * group A chip select register
CSB         equ REGSBASE+$112 * group B chip select register
CSC         equ REGSBASE+$114 * group C chip select register
CSD         equ REGSBASE+$116 * group D chip select register
************************************************
* PORT control registers
************************************************
PORTBASE    equ REGSBASE+$400 * port B registers base address
PBDir       equ PORTBASE+$08 * port B direction register
PBData      equ PORTBASE+$09 * port B data register
PBPU        equ PORTBASE+$0A * port B pullup enable register
PBSel       equ PORTBASE+$0B * port B select register

************************************************
* UART control registers
************************************************
USTCNT      equ REGSBASE+$900 * UART Status/Control Register
UBAUD       equ USTCNT+$02    * UART Baud Control Register
URX         equ USTCNT+$04    * UART Receiver Register
UTX         equ USTCNT+$06    * UART Transmitter Register
UMISC       equ USTCNT+$08    * UART Miscellaneous Register
NIPR        equ USTCNT+$0A    * UART Non-Integer Prescaler Register
...
* Setup CPU register
**************************************************
   move.b  #$30, $FFFFF119.L * emucs init, 3ws
   move.b  #$1c, $FFFFF000.L * SCR
   move.b  #$00, $FFFFFB0B.L * Disable WD
   move.b  #$03, $FFFFF42B.L * enable clko
   move.b  #$00, $FFFFF40B.L * enable chip select
   move.b  #$08, $FFFFFD0D.L * disable hardmap
   move.b  #$07, $FFFFFD0E.L * clear level 7 interrupt
   move.b  #$00, $FFFFF423.L * set PE3 as *DWE
***
* CSA
***
   move.w  #$8000, BASEA.L   * Group Base Add 8M
   move.w  #$01ED, CSA.L   * Chip Sel
***
* CSB
***
   move.w  #$8000, BASEB.L   * CSB
   move.w  #$0190, CSB.L   * disable eth + DPRAM - KH
************
* EDO DRAM
* 4Mx16(12/10)
************
   move.w  #$8F00, $FFFFFC00.L   * DRAM Config
   move.w  #$9667, $FFFFFC02.L   * DRAM Control
   move.w  #$0000, BASED.L       * CSD Address = 0
   move.w  #$069F, CSD.L         * enable DRAM cs
   move.b  #$40, $FFFFF300.L     * IVR
   move.l  #$007FFFFF.L, $FFFFF304.L   * IMR
************
* UART
************
   move.w   #$E100, USTCNT.L     * UART Status/Control Register
   move.W   #$0126, UBAUD.L      * UART Baud Control Register
*   move.W   #$000D, URX.l        * UART Receiver Register
   move.b   #$2F, UTX.L        * UART Transmitter Register
*   move.W   #$0080, UMISC.l      * UART Miscellaneous Register
*   move.w   #$0000, NIPR         * UART Non-Integer Prescaler Register
...
msgBanner:
    ...
    dc.b       'MC68EZ328 Flash ROM version 1.0 by kanpapa',CR,LF
    dc.b       '==============================',CR,LF,0
msgHelp:
